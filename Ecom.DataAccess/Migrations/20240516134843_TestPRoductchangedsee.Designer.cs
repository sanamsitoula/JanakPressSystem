...
namespace Ecom.DataAccess.Migrations
{
    ...
    [Migration("20240516134843_TestPRoductchangedsee")]
    partial class TestPRoductchangedsee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 33, 43, 362, DateTimeKind.Local).AddTicks(1620),
                            Description = "NEB",
                            DisplayOrder = 1,
                            Name = "NEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 33, 43, 362, DateTimeKind.Local).AddTicks(1635),
                            Description = "HSEB",
                            DisplayOrder = 3,
                            Name = "HSEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 33, 43, 362, DateTimeKind.Local).AddTicks(1637),
                            Description = "SLC",
                            DisplayOrder = 2,
                            Name = "SLC",
                            Status = true
