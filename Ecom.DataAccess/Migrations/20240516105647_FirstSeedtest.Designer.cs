...
namespace Ecom.DataAccess.Migrations
{
    ...
    [Migration("20240516105647_FirstSeedtest")]
    partial class FirstSeedtest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 16, 41, 46, 791, DateTimeKind.Local).AddTicks(9711),
                            Description = "NEB",
                            DisplayOrder = 1,
                            Name = "NEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 16, 41, 46, 791, DateTimeKind.Local).AddTicks(9726),
                            Description = "HSEB",
                            DisplayOrder = 3,
                            Name = "HSEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 16, 41, 46, 791, DateTimeKind.Local).AddTicks(9749),
                            Description = "SLC",
                            DisplayOrder = 2,
                            Name = "SLC",
                            Status = true
