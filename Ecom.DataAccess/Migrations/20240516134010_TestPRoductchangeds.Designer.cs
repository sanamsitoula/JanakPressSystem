...
namespace Ecom.DataAccess.Migrations
{
    ...
    [Migration("20240516134010_TestPRoductchangeds")]
    partial class TestPRoductchangeds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 25, 10, 202, DateTimeKind.Local).AddTicks(2151),
                            Description = "NEB",
                            DisplayOrder = 1,
                            Name = "NEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 25, 10, 202, DateTimeKind.Local).AddTicks(2164),
                            Description = "HSEB",
                            DisplayOrder = 3,
                            Name = "HSEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 25, 10, 202, DateTimeKind.Local).AddTicks(2166),
                            Description = "SLC",
                            DisplayOrder = 2,
                            Name = "SLC",
                            Status = true
