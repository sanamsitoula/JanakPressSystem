...
namespace Ecom.DataAccess.Migrations
{
    ...
    [Migration("20250317163752_InitialCreate3")]
            ...
            modelBuilder.Entity("Ecom.Models.JobTicket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Desc = "Description 1",
                            FiscalYearId = 1,
                            JobCompleteDate = new DateTimeOffset(new DateTime(2024, 1, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobDate = new DateTimeOffset(new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobStartDate = new DateTimeOffset(new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobStepId = "Step1",
                            JobTypeId = 1,
                            LotNumber = 100,
                            Name = "Job 1",
                        ...
                        new
                        {
                            ...
                            Desc = "Description 2",
                            FiscalYearId = 2,
                            JobCompleteDate = new DateTimeOffset(new DateTime(2024, 1, 2, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobDate = new DateTimeOffset(new DateTime(2024, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobStartDate = new DateTimeOffset(new DateTime(2024, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            JobStepId = "Step2",
                            JobTypeId = 1,
                            LotNumber = 101,
                            Name = "Job 2",
