...
namespace Ecom.DataAccess.Migrations
{
    ...
    [Migration("20240516132835_FormaDatasedd")]
    partial class FormaDatasedd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 13, 34, 943, DateTimeKind.Local).AddTicks(1774),
                            Description = "NEB",
                            DisplayOrder = 1,
                            Name = "NEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 13, 34, 943, DateTimeKind.Local).AddTicks(1787),
                            Description = "HSEB",
                            DisplayOrder = 3,
                            Name = "HSEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 16, 19, 13, 34, 943, DateTimeKind.Local).AddTicks(1789),
                            Description = "SLC",
                            DisplayOrder = 2,
                            Name = "SLC",
                            Status = true
