...
namespace Ecom.DataAccess.Migrations
{
    ...
    [Migration("20240517045754_JobTicketCha")]
    partial class JobTicketCha
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 17, 10, 42, 53, 788, DateTimeKind.Local).AddTicks(4547),
                            Description = "NEB",
                            DisplayOrder = 1,
                            Name = "NEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 17, 10, 42, 53, 788, DateTimeKind.Local).AddTicks(4564),
                            Description = "HSEB",
                            DisplayOrder = 3,
                            Name = "HSEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 17, 10, 42, 53, 788, DateTimeKind.Local).AddTicks(4565),
                            Description = "SLC",
                            DisplayOrder = 2,
                            Name = "SLC",
                            Status = true
