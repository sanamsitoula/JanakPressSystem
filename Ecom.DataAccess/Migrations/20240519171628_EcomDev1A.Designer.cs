...
namespace Ecom.DataAccess.Migrations
{
    ...
    [Migration("20240519171628_EcomDev1A")]
    partial class EcomDev1A
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecom.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 19, 23, 1, 27, 592, DateTimeKind.Local).AddTicks(9764),
                            Description = "NEB",
                            DisplayOrder = 1,
                            Name = "NEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 19, 23, 1, 27, 592, DateTimeKind.Local).AddTicks(9778),
                            Description = "HSEB",
                            DisplayOrder = 3,
                            Name = "HSEB",
                            Status = true
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = "1",
                            CreatedDate = new DateTime(2024, 5, 19, 23, 1, 27, 592, DateTimeKind.Local).AddTicks(9779),
                            Description = "SLC",
                            DisplayOrder = 2,
                            Name = "SLC",
                            Status = true
            ...
            modelBuilder.Entity("Ecom.Models.MachineJob", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedDate = new DateTime(2024, 5, 19, 17, 16, 27, 593, DateTimeKind.Utc).AddTicks(42),
                            Desc = "Description 1",
                            FormaId = 1,
                            FormaPageSize = 10,
                            InchargeId = 1,
                            JobDate = new DateTime(2024, 5, 19, 17, 16, 27, 593, DateTimeKind.Utc).AddTicks(32),
                            JobQuantity = 10,
                            JobStepId = "Step1",
                            JobTicketId = 1,
                            JobTypeId = 1,
                            ...
                            ProductId = 1,
                            Remarks = "Remarks 1",
                            ReportDate = new DateTime(2024, 5, 20, 17, 16, 27, 593, DateTimeKind.Utc).AddTicks(33),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 2,
                            CreatedDate = new DateTime(2024, 5, 19, 17, 16, 27, 593, DateTimeKind.Utc).AddTicks(48),
                            Desc = "Description 2",
                            FormaId = 2,
                            FormaPageSize = 10,
                            InchargeId = 2,
                            JobDate = new DateTime(2024, 5, 19, 17, 16, 27, 593, DateTimeKind.Utc).AddTicks(46),
                            JobQuantity = 10,
                            JobStepId = "Step2",
                            JobTicketId = 2,
                            JobTypeId = 2,
                            ...
                            ProductId = 2,
                            Remarks = "Remarks 2",
                            ReportDate = new DateTime(2024, 5, 21, 17, 16, 27, 593, DateTimeKind.Utc).AddTicks(46),
